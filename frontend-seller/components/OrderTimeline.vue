...
const timeline = ref([
    {
        number: 1,
        title: "Created",
        subtitle: "Please verify the payment and accept the order.",
        completed: true,
        type: "box",
        template: "created",
        line: true
    },
    {
        number: 2,
        title: "Shipping",
        subtitle: "Dispatch the package and press the dispatched button.",
        completed: false,
        type: "box",
        template: "shipping",
        line: true
    },
    {
        number: 3,
        title: "Finished",
        subtitle: "Collect funds when they become available.",
        completed: false,
        type: "button",
        template: "received",
        line: false
