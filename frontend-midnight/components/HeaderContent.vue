...
const items = ref([
  ...
  { label: 'Discord', route: 'https://discord.gg/MJ5Ckac6TV', external: true },
  { label: 'Docs', route: 'https://github.com/midso-dao', external: true },
  { label: 'Team', route: 'https://www.linkedin.com/in/rey-sudo', external: true }
])
